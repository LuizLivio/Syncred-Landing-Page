      ...
      <div class="hero-content">
        <div class="hero-text">
          <h1 class="hero-title">
            ...
            de forma simples, rápida e sem burocracia — direto da sua casa! 
          </h1>
          <p class="hero-description">
            Dinheiro na conta em poucas horas, com total segurança e as melhores taxas do mercado.
          </p>
          ...
          <div class="hero-buttons">
            ...
            >Quero antecipar meu FGTS agora</a>
          </div>
        </div>
